...
<head>
    ...
    <title>Registered student page for admin</title>
...
<body>
    ...
    <ul class="nav nav-tabs container justify-content-end my-4">
        ...
        <li class="nav-item dropdown">
            ...
            <li class="nav-item">
            <a class="nav-link" href="Regstud.php">SESSION</a>
        </li>
        </li>
        <li class="nav-item">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        foreach ($result as $know) {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    <?php echo htmlentities($know['Email']); ?>
                                </td>
                                <td class="center">
                                    <?php echo htmlentities($know['Phone number']); ?>
                                </td>
                                <td class="center">
                                ...
                                <td class="center">
                                                <?php
                                    if ($know['status'] == 0) { ?>
                                        <a href="RegStud.php?id=<?php echo htmlentities($know['Id']);?>"
                                           ><button
                                                type="button" class="btn btn-success" >Active</button>


                                        <?php } else { ?>
                                                <a href="RegStud.php?inid=<?php echo htmlentities($know['Id']); ?>"
                                                ><button
